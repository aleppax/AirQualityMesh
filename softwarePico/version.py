...
all_files = {
    ...
    '/libs' : ['ahtx0.py','bmp280.py','cron.py','datalogger.py','filelogger.py','__init__.py','leadacid.py','logger.py','mqttlogger.py','picosngcja5.py','qmc5883.py','sensors.py','simple.py','sps30.py','wlan.py'],
    '/logs' : [],
    '/html' : ['portal.html'], 
}
